...
| DNS Entry | DNS entry pointing to the loadbalancer enpoint  | User to decide the url and then generate this after Helm Chart install at this time the chart should output the loadbalancer DNS CNAME. Something like ai-vault.userdomain.com as decided by the user|
